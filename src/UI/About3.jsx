...
const About3 = () => {
  return (
    <div className='w-full min-h-screen bg-gray-100 flex items-center justify-between flex-col '>
      ...
      <div className="lg:w-full  lg:h-[30vw]  lg:grid grid-cols-3 gap-4 relative text-8xl text-blue-950 font-serif lg:mb-0 my-6">
        ...
        <div className="relative group overflow-hidden">
          ...
          <img
            ...
            alt="Rooms"
            className="absolute top-0 left-0 w-full lg:h-full h-[100vw] object-cover opacity-0 scale-105 group-hover:opacity-100 group-hover:scale-100 transition-all duration-700 ease-in-out z-10"
          />

          <div className="relative z-20 lg:h-full h-[100vw] w-full flex items-center justify-center hover:text-white  hover:scale-110 transition-all duration-300">
            Rooms
          </div>
        </div>
