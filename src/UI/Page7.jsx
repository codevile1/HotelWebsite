const Page7 = () => {
  return (
    <div className="w-full h-screen flex m-10 items-center justify-center overflow-hidden bg-gray-100  ">
      ...
      <div className="w-[40%] h-full overflow-y-scroll scrollbar-hide bg-gray-100">
      ...
      <div className="w-[40%] h-full flex flex-col justify-start items-start px-16 bg-gray-100 ml-8">
